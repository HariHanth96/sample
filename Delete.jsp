      ...
      <div class="card bg-dark text-white" style="border-radius: 1rem;">
         <div class="card-body p-5 text-center">
      		<div class="mb-md-5 mt-md-4 pb-5">
                    ...
                    <h2 class="fw-bold mb-2 text-uppercase">DELETION</h2>
                    <p class="text-white-50 mb-5">Please enter your login and password for Deleting</p>
                    ...
                    <input data-mdb-button-init data-mdb-ripple-init class="btn btn-outline-light btn-lg px-5" type="submit" value="Delete">
